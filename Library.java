    ...
    private static void showSignUpForm() {
        ...
        createAccountButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (firstName.isEmpty() || lastName.isEmpty() || username.isEmpty() || password.isEmpty() || confirmPassword.isEmpty() || contact.isEmpty() || ageText.isEmpty()) {
                ...
                if (gender == null) {
                    JOptionPane.showMessageDialog(signUpFrame, "Please select a gender.");
                    return;
                }
